          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
            ...
            >
              ...
              {categories.find(c => c.id === selectedCategory)?.pdfUrl && (
                <a
                  href={`https://docs.google.com/viewer?url=${encodeURIComponent(window.location.origin + (categories.find(c => c.id === selectedCategory)?.pdfUrl || ''))}&embedded=true`}
                  target="_blank"
                  rel="noopener noreferrer"
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {categories.find(c => c.id === currentLesson?.category)?.pdfUrl && (
                            <a
                              href={`https://docs.google.com/viewer?url=${encodeURIComponent(window.location.origin + (categories.find(c => c.id === currentLesson?.category)?.pdfUrl || ''))}&embedded=true`}
                              target="_blank"
                              rel="noopener noreferrer"
