...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    hero_title_2: "The Whole Story in the Bible",
    ...
    mission_title: "Become Good Ground",
    ...
    contact_title: "Contact a Minister",
    contact_desc: "Are you seeking to find a local congregation or have questions about the gospel? Get in touch with a Minister to begin your journey toward the promise.",
  ...
  tl: {
    ...
    hero_title_2: "Ang Buong Kwento sa Bibliya",
    ...
    mission_title: "Maging Mabuting Lupa",
    ...
    contact_title: "Makipag-ugnayan sa Ministro",
    contact_desc: "Nais mo bang makahanap ng lokal na kongregasyon o may mga katanungan tungkol sa ebangelio? Makipag-ugnayan sa isang Ministro upang simulan ang iyong paglalakbay patungo sa pangako.",
  ...
  es: {
    ...
    hero_title_2: "La Historia Completa en la Biblia",
    ...
    mission_title: "Conviértete en Buena Tierra",
    ...
    contact_title: "Contactar a un Ministro",
    contact_desc: "¿Busca encontrar una congregación local o tiene preguntas sobre el evangelio? Póngase en contacto con un Ministro para comenzar su viaje hacia la promesa.",
