...
export default function BaptismPage({ onBack, lang, onHover }: { onBack: (scrollToContact?: boolean) => void, lang: 'en' | 'tl' | 'es', onHover: (verse: string | null, x: number, y: number) => void }) {
  const steps = [
    {
      id: 1,
